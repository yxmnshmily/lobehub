...
description: >-
  Learn how to deploy LobeHub with database on Dokploy with ease, including: database, authentication and S3 storage service.
tags:
  - Deploy LobeHub
  - Vercel Deployment
  - OpenAI API Key
...
<Callout type={'info'}>
  For advanced features like SSO providers, magic link login, and email verification, see
  [Authentication Service](/docs/self-hosting/auth).
</Callout>
