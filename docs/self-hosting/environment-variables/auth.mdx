...
description: >-
  Explore the essential environment variables for configuring authentication services in LobeHub, including Better Auth, OAuth SSO, and provider-specific details.
tags:
