...
description: >-
  Learn about the common environment variables used to customize LobeHub deployment, including access code, OAuth SSO, base path, and default agent configuration.
tags:
  - LobeHub
