...
This is because LobeHub 2.0 uses the [pg_search](https://github.com/paradedb/paradedb/tree/main/pg_search) extension for full-text search capabilities. If you use Serverless Postgres services like Neon, the pg_search extension is only available on PostgreSQL 17.
