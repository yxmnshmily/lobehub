...
description: >-
  Guide for migrating your LobeHub deployment from Clerk authentication to Better Auth, including simple and full migration options.
tags:
...
4. **Notify Users**
   ...
   If Magic Link is enabled: The system will automatically send a login link email. Users can click the link to log in directly.
...
<Callout type={'tip'}>
  This method is quick and requires minimal setup. Users can log in via Magic Link, social accounts,
  or by setting a new password. All data remains intact. Users can manage their password and linked
  accounts anytime in the [Profile page](/settings/profile).
</Callout>
...
<Callout type={'tip'}>
  ...
  Configuration](/docs/self-hosting/auth).
</Callout>
