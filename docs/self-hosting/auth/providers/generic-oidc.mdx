...
description: >-
  Learn how to configure any OpenID Connect provider for LobeHub using Generic OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
  - Authentication
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with your OIDC provider and use
  LobeHub.
</Callout>
