...
description: >-
  Learn how to configure AWS Cognito SSO for LobeHub, including creating a User Pool and App Client in AWS Console.
tags:
  - AWS Cognito
  - Authentication
  - LobeHub
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with AWS Cognito and use LobeHub.
</Callout>
