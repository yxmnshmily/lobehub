...
description: >-
  Learn how to configure Microsoft (Entra ID / Azure AD) SSO for LobeHub, including creating applications in Azure Portal and setting up environment variables.
tags:
  - Microsoft
  - Authentication
  - Azure AD
...
<Image
  alt="App Register"
  inStep
  src="https://github.com/lobehub/lobehub/assets/13883964/4f9d83bd-b3fc-4abc-bcf4-ccbad65c219d"
/>
...
<Image
  alt="App Overview"
  inStep
  src="https://github.com/lobehub/lobehub/assets/13883964/48a0b702-05bd-4ce4-a007-a8ad00a36e5a"
/>
...
<Image
  ...
  inStep
  src="https://github.com/lobehub/lobehub/assets/13883964/c9d66fa0-158c-4bd3-a1fa-969e638259d2"
/>

<Callout type={'warning'}>
  Copy the client secret **Value** immediately - you won't be able to see it again.
</Callout>
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Microsoft and use LobeHub.
</Callout>
