...
description: >-
  Learn how to configure Logto SSO for LobeHub, including creating an application and setting up environment variables.
tags:
  - Logto
  - Authentication
  - LobeHub
...
<Callout type={'tip'}>
  Go to [📘 Environment Variables](/docs/self-hosting/environment-variables/auth#logto) for detailed
