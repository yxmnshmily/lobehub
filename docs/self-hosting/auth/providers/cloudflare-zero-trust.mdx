...
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for LobeHub, including creating an Access application.
tags:
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use
  LobeHub.
</Callout>
