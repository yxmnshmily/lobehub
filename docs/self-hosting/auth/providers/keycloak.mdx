...
description: >-
  Learn how to configure Keycloak SSO for LobeHub, including creating a client and setting up environment variables.
tags:
  - Keycloak
  - Authentication
  - LobeHub
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Keycloak and use LobeHub.
</Callout>
