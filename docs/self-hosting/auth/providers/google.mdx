...
description: >-
  Learn how to configure Google SSO for LobeHub, including creating OAuth credentials in Google Cloud Console and setting up environment variables.
tags:
  - Google
  - Authentication
  - LobeHub
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Google and use LobeHub.
</Callout>
