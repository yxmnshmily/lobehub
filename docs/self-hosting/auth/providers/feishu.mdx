...
description: >-
  Learn how to configure Feishu (Lark) SSO for LobeHub, including creating an application and setting up environment variables.
tags:
  - Feishu
  - Lark
  - Authentication
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Feishu and use LobeHub.
</Callout>
