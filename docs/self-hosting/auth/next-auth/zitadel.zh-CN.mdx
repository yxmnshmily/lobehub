...
<Callout type={'warning'}>
  NextAuth（Auth.js）已从 LobeHub 中完全移除。下文出现的 `NEXT_AUTH_SSO_PROVIDERS` 和 `AUTH_URL`
  等变量现在会导致部署在构建 / 启动阶段失败。本页仅作历史参考保留，请改用 [Better Auth
  提供商指南](/zh/docs/self-hosting/auth) 和 [NextAuth 迁移至 Better Auth
  指南](/zh/docs/self-hosting/migration/v2/auth/nextauth-to-betterauth)。
</Callout>
...
<Image
  alt="创建 ZITADEL 应用 1"
  inStep
  src="/blog/assets8692892/3564110d-bef9-47f3-b775-e5f28b4275b2.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 2"
  inStep
  src="/blog/assets8692892/12451b47-8dcd-40a9-b18d-2806b07efecc.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 3"
  inStep
  src="/blog/assets8692892/9d5cb651-ad10-47c7-8c8b-2256163c5521.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 4"
  inStep
  src="/blog/assets8692892/1699bf46-0c8d-4238-9eb5-34282bfe529a.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 5"
  inStep
  src="/blog/assets8692892/375b3d73-6796-465c-9063-f2762093f763.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 6"
  inStep
  src="/blog/assets8692892/40bb6b4c-18e0-4ae5-abae-ae0cf202cf08.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 7"
  inStep
  src="/blog/assets8692892/20a257b5-d086-46f3-b5c2-f76394b11f55.webp"
/>
...
<Image
  alt="创建 ZITADEL 应用 8"
  inStep
  src="/blog/assets8692892/79c55d44-8dcb-429c-a072-d3eb014bbceb.webp"
/>
