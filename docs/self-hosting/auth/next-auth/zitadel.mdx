...
description: >-
  Learn how to configure ZITADEL Authentication Service for LobeHub deployment, including creating ZITADEL applications, setting up environment variables, and enabling single sign-on (SSO).
tags:
...
<Callout type={'warning'}>
  NextAuth (Auth.js) has been fully removed from LobeHub. The `NEXT_AUTH_SSO_PROVIDERS` and
  `AUTH_URL` variables shown below will now cause the deployment to fail at build/startup. This page
  is kept for historical reference only — use the [Better Auth provider
  guides](/docs/self-hosting/auth) and the [NextAuth to Better Auth migration
  guide](/docs/self-hosting/migration/v2/auth/nextauth-to-betterauth) instead.
</Callout>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/b05473ad-04a6-4ebc-9810-116c778d4448.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/5a0e6c58-9e6f-4ffb-8af2-32e48cfb45b0.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/14ecaa12-74a1-4e2f-b171-9d9ac09d3d63.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/4ff3c3a0-9ca0-45ff-8f3a-219f4445098b.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/bee24764-aa42-47d9-ad43-bcb8e7b35bc3.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/407b4eed-7f21-4aa6-b68f-9bae2faf09d0.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/d84235b1-45f6-447d-bdd9-58ab9527dc9b.webp"
/>
...
<Image
  ...
  inStep
  src="/blog/assets8692892/d12a2661-7b98-484f-8f3d-07e84d42ae08.webp"
/>
