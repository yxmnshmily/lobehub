...
description: >-
  Learn how to configure Google SSO Authentication Service for LobeHub, create OAuth applications, add users, and set up environment variables for seamless integration.
tags:
  - Google SSO
  - OAuth 2.0
  - LobeHub
...
<Callout type={'info'}>
  - You can add or modify redirect URIs after registration, but make sure the URL matches your
  deployed LobeHub instance. - Replace "your-domain" with your actual domain.
</Callout>
...
<Image
  alt="Google OAuth Setup"
  inStep
  src="https://developers.google.com/static/identity/images/gsi/web/gcs-signin-2.png"
/>
...
<Callout>
  After successful deployment, users can sign in to LobeHub using their Google accounts (those added
  as Test Users, if not in production).
</Callout>
