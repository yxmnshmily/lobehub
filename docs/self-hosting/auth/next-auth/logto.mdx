...
description: >-
  Learn how to configure Logto authentication service in LobeHub, including deployment, creation, setting permissions, and environment variables.
tags:
...
<Callout type={'tip'}>
  ...
  with the LobeHub database version. In this case, LobeHub can share the same Postgres instance with
  it.
</Callout>
...
<Image
  ...
  inStep
  src="/blog/assetsffb84575674e2bc5dfdd07af8f41e794.webp"
/>
