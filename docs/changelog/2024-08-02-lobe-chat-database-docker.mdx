...
description: >-
  LobeHub v1.8.0 ships the official database Docker image, completing the server-side deployment stack with cloud data sync, user management, and comprehensive self-hosting documentation.
tags:
  - LobeHub
  - Docker Image
  - Cloud Deployment
