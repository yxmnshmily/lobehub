...
description: >-
  LobeHub 1.0 introduces server-side database support and comprehensive user management, enabling knowledge bases, cross-device sync, and team collaboration. LobeHub Cloud enters beta with these capabilities built-in.
tags:
  - LobeHub
  - Version 1.0
