...
description: >-
  LobeHub now supports both Clerk and Next-Auth, giving teams flexibility to choose the authentication approach that fits their deployment model and security requirements.
tags:
  - User Management
  - Next-Auth
  - Clerk
