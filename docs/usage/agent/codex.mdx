...
title: Codex
description: >-
  Delegate OpenAI Codex inside LobeHub — chat with the Codex CLI from your desktop app, watch file changes, todos, and command output stream in real time, and resume sessions across turns.
tags:
  - LobeHub
  - Codex
  - Coding Agent
...
If you change folders and the saved Codex thread can't be resumed safely, LobeHub shows: _"The saved Codex thread could not be resumed safely, so a new conversation has started for this topic."_
