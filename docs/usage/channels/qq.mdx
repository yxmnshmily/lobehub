...
description: >-
  Learn how to create a QQ bot and connect it to your LobeHub agent as a message channel, enabling your AI assistant to chat with users on QQ through group chats and direct messages.
tags:
  - QQ
  - Message Channels
  - Bot Setup
