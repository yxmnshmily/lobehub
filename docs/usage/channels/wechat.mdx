...
description: >-
  Learn how to connect a WeChat bot to your LobeHub agent via the iLink Bot API, enabling your AI assistant to chat with users on WeChat through private and group conversations.
tags:
  - WeChat
  - Message Channels
  - Bot Setup
