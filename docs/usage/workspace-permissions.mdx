...
description: >-
  A complete reference of what each workspace role — Owner, Member, and Viewer — can see and do in LobeHub, covering workspace management, billing, AI providers, skills, connectors, and content collaboration.
tags:
  - LobeHub
  - Workspace
  - Permissions
