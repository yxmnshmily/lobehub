...
description: >-
  Export your data from v1.x and import into v2.x Cloud or self-hosted. Step-by-step guide with troubleshooting.
tags:
  - LobeHub
  - Migration
  - v1.x
...
<Callout type="info">
  **Why the change?** The v1.x local database consumed more system resources, and only a small
  portion of users relied on it. By simplifying the client and focusing on cloud-first, we improve
  performance and ship new features faster.
</Callout>
...
<Callout type="warning">
  If your export contains sensitive content, store the file securely. Do not share it publicly or
