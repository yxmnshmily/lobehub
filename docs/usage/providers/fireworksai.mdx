...
description: >-
  Learn how to configure and use Fireworks AI's API Key in LobeHub to start chatting and interacting.
tags:
  - LobeHub
  - Fireworks AI
  - API Key
...
<Image
  alt={'Select Fireworks AI model and start chatting'}
  inStep
  src={'/blog/assetsba0243e75b0421b6dd7dadad02e4b0d6.webp'}
/>
