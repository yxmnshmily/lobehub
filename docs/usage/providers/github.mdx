...
description: >-
  Learn how to configure and use GitHub's API Key in LobeHub to start conversations and interactions.
tags:
  - LobeHub
  - GitHub
  - GitHub Models
...
<Image
  ...
  inStep
  src={'/blog/assets50607dece1bbffe80fdcbe76324ff9b6.webp'}
/>

<Callout type="note">
  These limits are subject to change. For the most up-to-date information, please refer to the
  [official GitHub
...
<Image
  ...
  inStep
  src={'/blog/assetsc376d2e9e97f9ea9d788589f0a9e23d6.webp'}
/>
...
<Callout type={'warning'}>
  Be sure to store your access token securely, as it will only be shown once. If you lose it, you’ll
...
<Image
  ...
  inStep
  src={'/blog/assetse0d53ba2bfb6ba5bf33f2b8a547f4e41.webp'}
/>
