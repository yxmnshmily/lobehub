...
description: >-
  Learn how to configure and use xAI's API Key in LobeHub to start chatting and interacting.
tags:
  - LobeHub
  - xAI
  - API Key
...
<Callout type={'warning'}>
  Make sure to save the API token shown in the popup — it will only be displayed once. If you lose
...
<Image
  alt={'Select xAI model and start chatting'}
  inStep
  src={'/blog/assets88248c034ef28ca9b909219d2e7ef32a.webp'}
/>
