...
description: >-
  Learn how to configure and use your InternLM API Key in LobeHub to start chatting and interacting.
tags:
  - LobeHub
  - InternLM
  - API Key
...
<Callout type={'warning'}>
  Make sure to save the API token shown in the pop-up window. It will only be displayed once. If you
...
<Image
  alt={'Select InternLM model and start chatting'}
  inStep
  src={'/blog/assets5205b6dd0f80b8ba02c297fcdfc1aecb.webp'}
/>
