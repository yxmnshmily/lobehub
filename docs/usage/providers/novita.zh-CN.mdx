...
description: >-
  学习如何将 Novita AI 的大语言模型 API 集成到 LobeHub 中。跟随以下步骤注册 Novita AI 账号、创建 API Key、充值信用额度并在 LobeHub 中进行设置。并与我们的多种 AI 模型交谈。
tags:
  - Novita AI
  - Llama3
  - Mistral
...
<Image
  alt={'在 LobeHub 中输入 Novita AI API 密钥'}
  inStep
