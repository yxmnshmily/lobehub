...
description: >-
  Easily chat with the locally deployed Qwen model through LobeHub's integration with Ollama. Learn how to install and select the Qwen model.
tags:
  - Qwen
  - Qwen Model
  - LobeHub Integration
...
<Image
  alt={'Using Qwen in LobeHub'}
  cover
  src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'}
/>
...
<Image
  alt={'Pulling the Qwen model using Ollama'}
  height={473}
  inStep
  src={'/blog/assets1845053/fe34fdfe-c2e4-4d6a-84d7-4ebc61b2516a.webp'}
/>
...
<Image
  alt={'Selecting the Qwen model in the model panel'}
  height={430}
  inStep
  src={'/blog/assets28616219/e0608cca-f62f-414a-bc55-28a61ba21f14.webp'}
/>
