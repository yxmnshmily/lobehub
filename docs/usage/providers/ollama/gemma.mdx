...
description: >-
  Easily perform natural language processing tasks with the Google Gemma model through LobeHub's integration with Ollama. Install Ollama, pull the Gemma model, select it from the model panel, and start chatting.
tags:
  - Google Gemma
  - LobeHub
  - Ollama
...
<Image
  alt={'Using Gemma in LobeHub'}
  cover
  rounded
  src={'/blog/assets17870709/65d2dd2a-fdcf-4f3f-a6af-4ed5164a510d.webp'}
/>
...
<Image
  alt={'Pulling the Gemma model using Ollama'}
  height={473}
  inStep
  src={'/blog/assets28616219/7049a811-a08b-45d3-8491-970f579c2ebd.webp'}
  width={791}
/>
...
<Image
  alt={'Selecting the Gemma model in the model panel'}
  height={629}
  inStep
  src={'/blog/assets28616219/69414c79-642e-4323-9641-bfa43a74fcc8.webp'}
  width={791}
/>
