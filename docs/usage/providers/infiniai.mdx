...
description: >-
  Learn how to configure and use Infini-AI's API Key in LobeHub to enable AI-powered conversations.
tags:
  - LobeHub
  - Infini-AI
  - API Key
...
<Callout type="info">
  Infini-AI enforces a whitelist mechanism for image URLs. Currently, image links from services like
  Alibaba Cloud OSS and AWS S3 are supported.\ If you encounter a 400 error when using image-based
  conversations, try [uploading images using base64
  encoding](/docs/self-hosting/environment-variables/s3#llm-vision-image-use-base-64).
</Callout>
