...
description: >-
  Learn how to obtain a GroqCloud API Key and configure Groq in LobeHub to experience its powerful performance.
tags:
  - LLAMA3
  - Qwen3
  - API keys
...
<Image
  alt={'Using Groq in LobeHub'}
  cover
  src={'/blog/assets17870709/1d840e27-fa74-4e71-b777-330bf41d6dff.webp'}
/>
...
<Callout type={'info'}>
  In internal benchmarks, Groq’s LPU Inference Engine consistently achieved speeds of 300 tokens per
  second. According to ArtificialAnalysis.ai, Groq outperforms other providers in both throughput
  (241 tokens per second) and total time to receive 100 output tokens (0.8 seconds).
</Callout>
...
<Image
  ...
  height={274}
  inStep
  src={'/blog/assets34400653/6942287e-fbb1-4a10-a1ce-caaa6663da1e.webp'}
/>
...
<Image
  ...
  height={274}
  inStep
  src={'/blog/assets34400653/eb57ca57-4f45-4409-91ce-9fa9c7c626d6.webp'}
/>

<Callout type={'warning'}>
  Make sure to save the key shown in the popup — it will only be displayed once. If you lose it,
...
<Video
  alt={'Select Groq Model'}
  src="/blog/assets28616219/b6b8226b-183f-4249-8255-663a5e9f5af4.mp4"
/>
