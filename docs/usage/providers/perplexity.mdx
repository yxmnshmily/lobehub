...
description: >-
  Learn how to configure and use Perplexity AI in LobeHub, obtain your API key, and choose the right language model to start chatting.
tags:
  - Perplexity AI
  - API key
  - Web UI
...
<Image
  alt={'Using Perplexity AI in LobeHub'}
  cover
  src={'/blog/assets17870709/0c2c399f-2ed3-44b5-97c8-53e007e8c095.webp'}
/>
...
<Image
  alt={'Create API Key'}
  inStep
  src={'/blog/assets17870709/80e22593-dc0f-482c-99bf-69acdb62d952.webp'}
/>
...
<Image
  alt={'Enter API Key'}
  inStep
  src={'/blog/assets17870709/51f8f8f6-5d8a-4cf0-a2e5-d96c69fe05b8.webp'}
/>
...
<Image
  alt={'Select Perplexity AI model and start chatting'}
  inStep
  src={'/blog/assets17870709/e6a429cb-96e1-4e85-9aa3-1334ffcad8c0.webp'}
/>
