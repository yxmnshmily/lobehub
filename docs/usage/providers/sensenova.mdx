...
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in LobeHub to start chatting and interacting.
tags:
  - LobeHub
  - SenseTime SenseNova
  - API Key
...
<Image
  ...
  inStep
  src={'/blog/assetsfae60ba54155478a1c363f0065ce76a6.webp'}
/>
...
<Callout type={'warning'}>
  Make sure to save the access key shown in the pop-up window. It will only be displayed once. If
...
<Image
  alt={'Select SenseNova Model and Start Chatting'}
  inStep
  src={'/blog/assets52c8de6425a785409464561c09f8c98d.webp'}
/>
