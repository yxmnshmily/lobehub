...
description: >-
  Learn how to configure and use Stepfun's AI models in LobeHub, including how to obtain an API key and select a model to start chatting.
tags:
  - Stepfun
  - API key
  - Web UI
...
<Image
  alt={'Using Stepfun in LobeHub'}
  cover
  src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'}
/>
...
<Image
  alt={'Get your Stepfun API key'}
  inStep
  src={'/blog/assets34400653/33d8ce3b-0083-48aa-9a66-3825e726c4de.webp'}
/>
...
<Image
  ...
  inStep
  src={'/blog/assets34400653/470e5669-650b-46cf-8024-a1476c166059.webp'}
/>
...
<Image
  alt={'Select a Stepfun model and start chatting'}
  inStep
  src={'/blog/assets34400653/0275a552-f189-42b5-bf40-f9891c428b3d.webp'}
/>
