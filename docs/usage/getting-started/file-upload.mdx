...
description: >-
  Upload files to conversations and knowledge bases — documents, code, images, and more. AI agents analyze and reference your files.
tags:
  - LobeHub
  - File Upload
  - Documents
...
<Accordion title="Include Context Documents">
  Upload README files, glossaries, or context documents to help AI understand domain-specific
  content.
</Accordion>
...
<Accordion title="Use Text-Extractable Formats">
  Text-extractable formats (PDF, DOCX, TXT) work better than image-only documents for search and
  analysis.
</Accordion>
