...
description: >-
  Discover, install, configure, and organize Skills — the tools and integrations that extend what your Agents can do.
tags:
  - Skills
  - LobeHub
  - MCP
...
<Callout type={'info'}>
  For STDIO MCPs, environment variables are the standard way to pass API keys and secrets without
  exposing them in the command line.
</Callout>
