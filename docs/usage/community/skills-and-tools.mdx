...
description: >-
  Understand the difference between Skills and Tools — what agents know vs. what agents can do.
tags:
  - LobeHub
  - Skills
  - Tools
...
<Accordion title="Tool Not Being Used">
  - Confirm tool is enabled in agent settings - Make request more explicit: "Use web search to
  find..." - Check tool permissions are granted - Verify API keys are configured
</Accordion>
