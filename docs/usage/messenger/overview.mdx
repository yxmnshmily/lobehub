...
description: >-
  Connect your LobeHub account to the official LobeHub bot on Telegram, Slack, and Discord. Link once, pick an active agent, and chat with your assistants from the chat apps you already use — no bot setup required.
tags:
  - Messenger
  - Telegram
  - Slack
...
| Action | Effect |
| --- | --- |
| **Disconnect** on a _user_ row | Unlinks **your** LobeHub account from the platform account. Inbound messages stop until you `/start` again. |
| **Disconnect** on a _workspace / server_ row | Removes the install audit entry. On Slack, this also freezes the workspace bot for everyone. On Discord, the bot stays in the server until a server admin kicks it. |
