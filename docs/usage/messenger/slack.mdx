...
description: >-
  Install the official LobeHub Slack app to your workspace, then link each member's Slack account to LobeHub. Pick a default agent and chat with your AI assistants from Slack DMs — no bot setup required.
tags:
  - Messenger
  - Slack
  - LobeHub Bot
...
| Action | Effect |
| --- | --- |
| **Disconnect** on a _user_ row | Unlinks **your** LobeHub account from your Slack account in this workspace. Your inbound DMs stop until you message the bot and link again. |
| **Disconnect** on a _workspace_ row | Removes the workspace install. The bot is **frozen for everyone** in that workspace because dispatch is token-gated — existing user links remain on file but pause until the workspace is re-installed. |
