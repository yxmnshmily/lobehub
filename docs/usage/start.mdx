...
<Image
  alt={'LobeHub'}
  cover
  src={'https://hub-apac-1.lobeobjects.space/blog/assets/341c0d38baf2ddbb2ca6a1407129a62a.webp'}
/>
...
<Image
  alt={'create with LobeHub'}
  cover
  src={'https://hub-apac-1.lobeobjects.space/blog/assets/2204cde2228fb3f583f3f2c090bc49fb.webp'}
/>
...
<Image
  alt={'collaborate with LobeHub'}
  cover
  src={'https://hub-apac-1.lobeobjects.space/blog/assets/771ff3d30b9ef93e65e55021cc43d356.webp'}
/>
...
<Image
  alt={'evolve with LobeHub'}
  cover
  src={'https://hub-apac-1.lobeobjects.space/blog/assets/fe98eae9fcb6acc47c8e1fb69bdb4b50.webp'}
/>
...
- _"Summarize the top 5 GitHub issues and post a digest to Slack"_ → your Agent reads the issues, writes the summary, sends the message.
- _"Pull this week's sales data and build a chart"_ → your Agent queries the database, processes the numbers, renders a visual Artifact.
- _"Find flights to Tokyo next month under $800"_ → your Agent searches, compares, and presents options with booking links.
...
Generic AI answers are fine for generic questions. But when you need an Agent that knows _your_ codebase, _your_ product docs, _your_ company policies, the [Resource Library](/docs/usage/agent/resources) is where you start.
