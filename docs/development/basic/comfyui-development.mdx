...
description: >-
  Learn how to add new models, workflows, and features to LobeHub's ComfyUI integration
tags:
  - ComfyUI
  - Development Guide
  - Model Extension
...
describe.each(Object.entries(models).filter(([name]) => workflowBuilders[name]))(
  '%s parameter mapping',
