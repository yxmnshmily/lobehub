...
Please refer to the [Environment Setup Guide](/docs/development/basic/setup-development) for the complete setup process, including software installation, project configuration, Docker service startup, and database migrations.
...
LobeHub uses `react-i18next` for multilingual support, ensuring a global user experience.
