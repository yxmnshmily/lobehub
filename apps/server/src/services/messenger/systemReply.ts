...
const EN_US: MessengerSystemStrings = {
  accountAlreadyLinked:
    'Your account is already linked to 旅游群. Send /groups to choose a workgroup, or /new to start a fresh conversation.',
  ...
  agentsDirectMessageOnly: 'Open your direct message with the 旅游群 bot and send `/agents` there.',
  agentsEmpty: 'You have no agents yet. Create one in 旅游群, then come back to /agents.',
  ...
  checkDirectMessage: 'Check your DM with 旅游群 for the link button.',
  currentMarker: 'current',
  genericError: 'Something went wrong.',
  help: [
    'Commands:',
    '• /start — bind (or rebind) your 旅游群 account',
    '• /switch — switch the active scope (personal or a workspace)',
    '• /agents — list your agents and switch the active one',
    '• /groups — list workgroups; /groups <number> to select one',
    '• /new — start a new conversation',
    '• /mode — show or switch the conversation mode (agent | chat)',
    '• /stop — stop the current execution',
    '• /feedback <message> — send feedback to the 旅游群 team (no AI reply)',
  ].join('\n'),
  modeAgentLabel: 'Agent Mode',
  modeChangedToast: (label) => `Switched to ${label}.`,
  modeChatLabel: 'Chat Mode',
  modeDirectMessageOnly: 'Open your direct message with the 旅游群 bot and send `/mode` there.',
  modePicker: 'Pick the conversation mode:',
  needLink: 'You need to /start to bind your account first.',
  newDirectMessageOnly: 'Open your direct message with the 旅游群 bot and send `/new` there.',
  newStarted: 'Started a new conversation. Your next message begins a fresh topic.',
  noActiveAgent:
    'No workgroup selected. Send /groups or choose a workgroup in chat platform settings.',
  ...
  scopeSwitched: (name, agentTitle) =>
    agentTitle
      ...
      : `Switched to ${name}. No agents here yet — create one in 旅游群, then /agents.`,
  ...
  startDirectMessageOnly:
    'Open your direct message with the 旅游群 bot and send `/start` there to link your account.',
  staleAgent:
  ...
  stopDirectMessageOnly: 'Open your direct message with the 旅游群 bot and send `/stop` there.',
...
const ZH_CN: MessengerSystemStrings = {
  accountAlreadyLinked:
    '你的账号已绑定到旅游群。发送 /groups 可选择工作群，发送 /new 可开启新对话。',
  ...
  agentsDirectMessageOnly: '请在与 旅游群 机器人的私聊中发送 `/agents`。',
  agentsEmpty: '你还没有 Agent。请先在 旅游群 创建，然后再发送 /agents。',
  ...
  checkDirectMessage: '请查看与 旅游群 机器人的私聊消息，并点击其中的绑定按钮。',
  currentMarker: '当前',
  genericError: '发生错误，请稍后再试。',
  help: [
    '可用命令：',
    '• /start — 绑定（或重新绑定）旅游群 账号',
    '• /switch — 切换当前空间（个人账号或工作区）',
    '• /agents — 查看 Agent 并切换当前 Agent',
    '• /groups — 查看工作群，发送 /groups 序号 选择工作群',
    '• /new — 开启新对话',
    '• /mode — 查看或切换会话模式（agent | chat）',
    '• /stop — 停止当前执行',
    '• /feedback <内容> — 向 旅游群 团队发送反馈（不会触发 AI 回复）',
  ].join('\n'),
  modeAgentLabel: 'Agent 模式',
  modeChangedToast: (label) => `已切换到${label}。`,
  modeChatLabel: 'Chat 模式',
  modeDirectMessageOnly: '请在与 旅游群 机器人的私聊中发送 `/mode`。',
  modePicker: '请选择会话模式：',
  needLink: '请先发送 /start 绑定你的 旅游群 账号。',
  newDirectMessageOnly: '请在与 旅游群 机器人的私聊中发送 `/new`。',
  newStarted: '已开启新对话，下一条消息会创建一个新话题。',
  noActiveAgent: '当前未选择工作群。请发送 /groups，或在聊天平台设置中选择工作群。',
...
const WECHAT_ZH_CN: MessengerSystemStrings = {
  ...
  needLink: '当前微信账号尚未连接，请前往 旅游群 的 Messenger 设置重新扫码。',
  notLinked: '当前微信账号尚未连接，请前往 旅游群 的 Messenger 设置重新扫码。',
};
