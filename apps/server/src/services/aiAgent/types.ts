...
export interface InternalExecAgentParams extends ExecAgentParams {
  ...
  /**
   * Server-authored execution context. The hosted-group binding is deliberately
   * absent from the public schema and is only attached after membership and
   * billing principals have been validated.
   */
  appContext?: NonNullable<ExecAgentParams['appContext']> & { hostedGroupRun?: unknown };
  /**
