...
export const TRPC_NAMESPACE_API_KEY_RULES: Record<string, TrpcNamespaceScopeRule> = {
  ...
  config: 'open',
  connector: 'blocked',
  // Personal account, billing and collaboration surfaces require an
  // interactive signed-in user. Restricted API keys must not automate them.
  customerCenter: 'blocked',
  device: 'blocked',
  ...
  groupConversation: 'blocked',
  groupMembership: 'blocked',
  groupSponsoredCredit: 'blocked',
  healthcheck: 'open',
  ...
  platformCredit: 'blocked',
  platformCreditPurchase: 'blocked',
  platformModeration: 'blocked',
  platformOperations: 'blocked',
  ...
  travelGeneration: 'blocked',
  travelServiceLedger: 'blocked',
