...
export const SkillStoreManifest: BuiltinToolManifest = {
  ...
  meta: {
    avatar: '🏪',
    description:
      'Browse and install agent skills from the 旅游群 marketplace. MUST USE this tool when users mention: "SKILL.md", "旅游群 Skills", "skill store", "install skill", "search skill", or need extended capabilities.',
    title: 'Skill Store',
  },
