export default {
  ...
  'desktop.openSettings.desc': 'Open the account center page',
  'desktop.openSettings.title': 'Account Center',
  ...
  'navigateToChat.desc': 'Switch to the Chat tab and enter Travel Group Owner AI',
