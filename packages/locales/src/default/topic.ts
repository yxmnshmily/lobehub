export default {
  'management.columns.association': '关联',
  'management.columns.credits': '消耗积分',
  'management.association.none': '未关联',
  'management.association.goal': '目标',
  'management.association.task': '任务',
  'management.association.project': '项目',
  'management.creditsHint': '仅按本话题已记录成本折算积分；实际扣费以个人中心流水为准。',
  ...
  'management.filters.project.empty': '暂无关联项',
  'management.filters.project.label': '关联',
  ...
  'management.group.byProject': '按关联',
