...
export default {
  'errorBoundary.editor': 'Editor error',
  'errorBoundary.render': 'Unable to display this content',
  'errorBoundary.details': 'View error details',
  'errorBoundary.message': 'This content could not be displayed. See the error details below.',

  'runUsage.summary': '耗时 / 积分总消耗',
  'runUsage.equivalentCredits': '积分总消耗',
  'runUsage.referenceCost': '消耗',
  'runUsage.durationHint': '已结束轮次的累计运行时间，包含子任务；并行轮次累加，不是等待时长。',
  'runUsage.creditsHint':
    '按已记录成本折算，沿用现有人民币定价与积分换算；实际扣费以个人中心积分流水为准。',
  'runUsage.minutes': '分钟',
  'runUsage.hours': '小时',
  'runUsage.days': '天',

  ...travelUi,
  'resourceDeletion.deleteError': 'Deletion failed. Please retry.',
  'resourceDeletion.changed':
    'The deletion scope changed. Review the updated counts and confirm again.',
  'resourceDeletion.cleanupPending': 'Content deleted; file cleanup needs a retry',
  'resourceDeletion.retry': 'Retry file cleanup',
  'resourceDeletion.cleanupDone': 'Files permanently removed',
  'resourceDeletion.title': 'Confirm permanent deletion',
  'resourceDeletion.previewing': 'Calculating deletion impact…',
  'resourceDeletion.previewError':
    'Unable to calculate deletion impact. Nothing was deleted. Please retry.',
  'resourceDeletion.description':
  ...
  'resourceDeletion.deleting': 'Permanently delete',
  'resourceDeletion.retained': 'Shared resources retained',
  'resourceDeletion.goals': 'Goals',
  'resourceDeletion.tasks': 'Tasks',
  'resourceDeletion.topics': 'Topics',
  'resourceDeletion.files': 'Files',
  'resourceDeletion.cancel': 'Cancel',
  'resourceDeletion.confirm': 'Permanently delete',

  'bulkDelete.selectVisible': 'Select all in this list',
  'bulkDelete.selectItem': 'Select {{name}}',
  'bulkDelete.deleteSelected': 'Delete ({{count}})',
  'bulkDelete.confirmTitle': 'Delete {{count}} selected items?',
  'bulkDelete.goalDescription': 'Delete the selected {{count}} goals. This cannot be undone.',
  'bulkDelete.taskDescription': 'Delete the selected {{count}} tasks. This cannot be undone.',
  'bulkDelete.projectDescription': 'Delete the selected {{count}} projects. This cannot be undone.',
  'bulkDelete.topicDescription':
    'Permanently delete the selected {{count}} topics and their conversation messages. These conversations will also disappear from the corresponding group. This cannot be undone.',
  'bulkDelete.partialFailure':
    '{{count}} items could not be deleted. They remain selected so you can retry.',
  'bulkDelete.success': 'Deleted {{count}} items',
  'agent.manage': 'Manage',
  ...
  'messengerBanner.title': 'Talk to Travel Group Owner AI on your favorite messaging apps',
  ...
  'cmdk.askLobeAI': 'Ask Travel Group Owner AI',
  ...
  'taskTemplate.action.create.success': 'Scheduled task added. Find it in Travel Group Owner AI.',
