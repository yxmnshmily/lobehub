export default {
  ...
  'betterAuth.signin.emailTab': 'Email sign-in',
  ...
  'betterAuth.signin.phoneTab': 'Phone sign-in',
  ...
  'betterAuth.phone.codeInvalid': 'Enter the 6-digit verification code',
  'betterAuth.phone.codePlaceholder': 'SMS code',
  'betterAuth.phone.phoneInvalid': 'Enter a valid mainland China phone number',
  'betterAuth.phone.phonePlaceholder': 'Enter your phone number',
  'betterAuth.phone.phoneRequired': 'Enter your phone number',
  'betterAuth.phone.resend': 'Resend code',
  'betterAuth.phone.resendIn': 'Resend in {{seconds}}s',
  'betterAuth.phone.sendCode': 'Send code',
  'betterAuth.phone.sendFailed': 'Could not send the code. Please try again later.',
  'betterAuth.phone.signInOrSignUp': 'Sign in or sign up',
  'betterAuth.phone.verifyFailed': 'The code is incorrect or has expired',
  ...
  'betterAuth.verifyEmail.alreadyVerified.description':
    'This email is already verified. You can continue to the app.',
  'betterAuth.verifyEmail.alreadyVerified.title': 'Email Already Verified',
  ...
  'betterAuth.verifyEmail.error.description':
    'We could not verify this email. Please return to sign in and try again.',
  'betterAuth.verifyEmail.error.title': 'Email Verification Failed',
  'betterAuth.verifyEmail.expired.description':
    'This verification link is invalid or has expired. Please request a new email.',
  'betterAuth.verifyEmail.expired.title': 'Verification Link Expired',
  'betterAuth.verifyEmail.otp.description':
    'Enter the 6-digit verification code sent to your email.',
  'betterAuth.verifyEmail.otp.error':
    'The verification code is invalid or expired. Please try again.',
  'betterAuth.verifyEmail.otp.inputLabel': '6-digit verification code',
  'betterAuth.verifyEmail.otp.invalid': 'Enter a valid 6-digit verification code.',
  'betterAuth.verifyEmail.otp.placeholder': '6-digit code',
  'betterAuth.verifyEmail.otp.resend': 'Resend in {{seconds}}s',
  'betterAuth.verifyEmail.otp.resendReady': 'Resend verification code',
  'betterAuth.verifyEmail.otp.sendError': 'Could not send a code. Please try again later.',
  'betterAuth.verifyEmail.otp.sent': 'If this email can be verified, a 6-digit code has been sent.',
  'betterAuth.verifyEmail.otp.submit': 'Verify code',
  'betterAuth.verifyEmail.otp.useCode': 'Use a 6-digit verification code',
  'betterAuth.verifyEmail.otp.useLink': 'Use the email verification link instead',
  'betterAuth.verifyEmail.resend.button': 'Resend Verification Email',
  'betterAuth.verifyEmail.resend.alreadyVerified': 'This email is already verified',
  ...
  'betterAuth.verifyEmail.resend.rateLimited':
    'Too many requests. Please wait a moment before trying again.',
  'betterAuth.verifyEmail.resend.success': 'Verification email resent. Please check your inbox.',
  'betterAuth.verifyEmail.success.continue': 'Continue',
  'betterAuth.verifyEmail.success.description':
    'Your email has been verified. You can now continue using {{appName}}.',
  'betterAuth.verifyEmail.success.title': 'Email Verified',
  ...
  'profile.phoneRequiredForGroupAi': 'Please bind your phone number first',
  'profile.groupAiUnavailable': 'Group AI unavailable',
  'profile.bindPhone': 'Bind phone number',
  'profile.changePhone': 'Change phone number',
  'profile.confirmPhone': 'Verify and bind',
  'profile.phoneNotBound': 'Not bound',
  'profile.userId': 'User ID',
  'profile.phoneRequired': 'Please bind your phone number (required)',
  'profile.phoneInUse': 'This phone number is already linked to an account. Use another number.',
  'profile.phoneUnavailable': 'SMS verification is currently unavailable',
  'profile.changePassword': 'Change password',
  'profile.changePasswordError':
    'Unable to change the password. Check your current password and try again.',
  'profile.changePasswordSuccess': 'Password changed. Other devices have been signed out.',
  ...
  'profile.emailChangeError': 'Unable to change the email right now. Please try again later.',
  'profile.emailInUse': 'This email is already in use. Please choose another one.',
  'profile.emailInvalid': 'Please enter a valid email address',
  'profile.emailPlaceholder': 'new-email@example.com',
  'profile.fullName': 'Fullname',
  'profile.fullNameRequired': 'Please set your name / nickname (required)',
  'profile.fullNameTooLong': 'Name / nickname must be 64 characters or fewer',
  'profile.edit': 'Edit',
  'profile.set': 'Set',
  'profile.usernameOptional': 'Not set (optional)',
  'profile.wechatCompleteProfile':
    'You signed in with WeChat. Please set or confirm your name / nickname and bind your phone number below.',
  ...
  'profile.sso.loadError': 'Could not load linked accounts. Please retry.',
  'profile.sso.retry': 'Retry',
  ...
  'signin.appName': 'Travel Community Network',
  'signin.subtitle': 'Sign in to your {{appName}} account',
