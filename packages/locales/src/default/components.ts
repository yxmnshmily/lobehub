export default {
  ...
  'ModelSwitchPanel.detail.pricing.units.image': '/img',
  'ModelSwitchPanel.detail.pricing.units.megapixel': '/MP',
  'ModelSwitchPanel.detail.pricing.units.millionCharacters': '/M chars',
  'ModelSwitchPanel.detail.pricing.units.millionTokens': '/M tokens',
  'ModelSwitchPanel.detail.pricing.units.second': '/s',
  'ModelSwitchPanel.detail.pricing.units.video': '/video',
