export default {
  ...
  'groupDiscussion.saving': 'Saving discussion limit…',
  'groupDiscussion.saveError': 'Could not save the discussion limit. Select it again to retry.',
  'agentProfile.viewProfile': 'View profile',
  'groupInvitation.share': 'Share group',
  'groupInvitation.ownerOnly': 'Ask the group owner to generate an invitation link.',
  'groupInvitation.hint':
    'The link and QR code expire in 7 days. Recipients can sign in or register, then confirm to join. Share only with people you want to invite.',
  'groupInvitation.link': 'Group invitation link',
  'groupInvitation.copy': 'Copy invitation link',
  'groupInvitation.copied': 'Invitation link copied',
  'groupInvitation.copyError': 'Copy failed. Select the link above to copy it manually.',
  'groupInvitation.create': 'Create invitation link and QR code',
  'groupInvitation.createAnother': 'Create another invitation link',
  'groupInvitation.revoke': 'Disable all invitation links',
  'groupInvitation.revoked':
    'All existing invitation links are disabled. Existing members are unaffected.',
  'groupInvitation.failed': 'The action failed. Please try again.',
  'groupInvitation.invalid': 'This invitation is invalid or expired. Ask the owner for a new link.',
  'groupInvitation.joinError': 'Unable to join. Ask the owner to check or renew your invitation.',
  'groupInvitation.confirmHint': 'Confirm to join this group and chat with its members.',
  'groupInvitation.join': 'Confirm and join group',
  'groupInvitation.signin': 'Sign in to join',
  'groupInvitation.signup': 'Register to join',
  'groupInvitation.group': 'Invited group',
  'groupInvitation.title': 'Group invitation',

  'superGroup.pendingInvitations': 'You have {{amount}} group invitations',
  'superGroup.invitationHint':
    'Someone invited you to their work group. You only join after accepting.',
  'superGroup.viewInvitations': 'View invitations',
  'groupMembership.aiPromptLimit':
    'AI tasks accept up to {{limit}} characters. Shorten the content or send it as a regular message.',
  'groupMembership.handoffMultiple': 'Assign to {{count}} assistants',
  'groupMembership.waitingForOwner': 'Waiting for confirmation. Ask the group owner to review.',
  'groupMembership.loadMoreMessages': 'Load more messages',
  'groupMembership.joinedTitle': '{{name}}’s group',
  'groupMembership.recentTopics': 'Recent topics',
  'groupMembership.memberHint': 'Chat with group members and use @ to work with assistants.',
  'groupMembership.target': '@ a group assistant',
  'groupMembership.automaticCoordinator': 'Let the group coordinator decide',
  'groupMembership.rosterError': 'Assistants could not be loaded. Try again later.',
  'groupMembership.handoff': 'Send to @{{name}}',
  'groupMembership.title': 'Group members',
  'groupMembership.actionError': 'The action failed. Please retry.',
  'groupMembership.templateRemoveDescription':
    "Remove {{name}} from all users' default groups? The original profile and message history will be preserved.",
  'groupMembership.loadError': 'Members could not be loaded.',
  'groupMembership.retry': 'Retry',
  'groupMembership.people': 'People',
  'groupMembership.owner': 'Group owner',
  'groupMembership.removeTitle': 'Remove this member?',
  'groupMembership.removeDescription':
    'Their access and personal conversation history will be cleared. Other members will keep the group history.',
  'groupMembership.remove': 'Remove member',
  'groupMembership.removed': 'Member removed.',
  'groupMembership.previous': 'Previous',
  'groupMembership.next': 'Next',
  'groupMembership.invited': 'Invitation sent. They will join after accepting.',
  'groupMembership.contact': 'User ID, phone number or email',
  'groupMembership.inviteError':
    'Invitation could not be sent. Check the registered contact and try again.',
  'groupMembership.email': 'Invite by email',
  'groupMembership.inviteMembers': 'Invite group members',
  'groupMembership.invite': 'Send invitation',
  'groupMembership.assistants': 'AI members',
  'groupMembership.assistantHint':
    'View an assistant’s introduction here. Use @ in the group to work with them.',
  'groupMembership.search': 'Search assistants',
  'groupMembership.noAssistants': 'No matching assistants.',
  'groupMembership.unnamedAssistant': 'Assistant',
  'groupMembership.noDescription': 'No introduction has been added yet.',
  'groupMembership.leaveTitle': 'Leave this group?',
  'groupMembership.leaveDescription':
  ...
  'groupMembership.leave': 'Leave group',
  'groupMembership.left': 'You have left the group.',
  'superGroup.groupsError': 'Groups could not be loaded.',
  'superGroup.topicsError': 'Topics could not be loaded.',
  'superGroup.noTopics': 'Topics will appear here as the conversation develops.',
  'superGroup.untitledTopic': 'Untitled topic',
  'superGroup.user': 'User',
  'superGroup.joinedGroup': '{{name}}’s group',
  'superGroup.ownGroup': 'My super work group',
  'superGroup.recentTopics': 'Latest 10 topics',
  'superGroup.otherGroups': 'Other conversations',
  'superGroup.template.heading': 'Super work group assistants',
  'superGroup.template.hint':
    'Changes sync to every user’s default group. Chat histories remain separate and are not changed. Up to 100 assistants.',
  'superGroup.template.loadError': 'Assistant template could not be loaded.',
  'superGroup.template.add': 'Add assistant',
  'superGroup.template.title': 'Assistant name',
  'superGroup.template.avatar': 'Avatar (emoji or image URL)',
  'superGroup.template.description': 'Public introduction',
  'superGroup.template.systemRole': 'Assistant instructions (administrator only)',
  'superGroup.template.save': 'Save and sync to all groups',
  'superGroup.template.cancel': 'Cancel',
  'superGroup.template.saveError':
    'Save could not be confirmed. Your draft is retained; you can safely retry.',
  'superGroup.template.saved': 'Saved and synced to {{count}} groups.',
  ...
  'builtinCopilot': 'Travel Group (Supervisor)',
  ...
  'messageAction.regenerateKeepHistory': 'Regenerate (Keep History)',
  ...
  'messages.modelCard.creditPricing': 'Credits/token',
  'messages.modelCard.creditTooltip':
    'Credits follow model pricing. Changing the language or display currency does not change credit amounts.',
  'messages.modelCard.pricing.inputCachedTokens':
    'Cached input {{amount}} credits/token · {{money}}/M tokens (reference price)',
  'messages.modelCard.pricing.inputCharts': '${{amount}}/M characters',
  'messages.modelCard.pricing.inputMinutes': '${{amount}}/minute',
  'messages.modelCard.pricing.inputTokens':
    'Input {{amount}} credits/token · {{money}}/M tokens (reference price)',
  'messages.modelCard.pricing.outputTokens':
    'Output {{amount}} credits/token · {{money}}/M tokens (reference price)',
  'messages.modelCard.pricing.writeCacheInputTokens':
    'Cache write {{amount}} credits/token · {{money}}/M tokens (reference price)',
  ...
  'shareModal.archive.all': 'All',
  'shareModal.archive.images': 'Images',
  'shareModal.archive.text': 'Text',
  'shareModal.archive.media': 'Multimedia',
  'shareModal.archive.documents': 'Documents',
  'shareModal.archive.other': 'Other',
  'shareModal.archive.empty': 'No content in this category in the current conversation.',
  'shareModal.archive.readText': 'Read full text',
  'shareModal.archive.scope': 'Automatically organized from the current conversation',
  'shareModal.archive.export': 'Export conversation',
  'shareModal.archive.back': 'Back to content',
  'shareModal.archive.title': 'Conversation content',
  'shareModal.files': 'Files',
  'shareModal.filesEmpty':
    'No downloadable attachments or document links in this conversation. Export plain text using Text or PDF.',
  'shareModal.downloadOriginal': 'Download original',
  'shareModal.exportDocument': 'Export Markdown',
  'shareModal.fileDownloadError': 'Export failed. Check your file access and try again.',
  ...
  'shareModal.popover.selectedTopic': 'Sharing topic: {{title}}',
  'shareModal.popover.topicOpening': 'Opening message: {{content}}',
  'shareModal.popover.visibleTopicAction': 'Share the topic at this scroll position',
  'shareModal.popover.visibleTopicHint':
    'Selected from the message near the upper quarter of the chat area when you clicked Share. Shares the entire topic, including later messages—not just this screen. Other topics stay private. Close this panel and scroll to change the topic.',
  'shareModal.popover.visibleTopicMissing':
    'No saved topic is visible. Scroll to the conversation you want to share and try again.',
  ...
  'taskDetail.topicMenu.openGroupTopic': 'Go to group conversation',
  ...
  'taskList.unassignedAgentHint':
    'Travel Group Owner AI will run this task when no agent is selected',
  ...
  'you': 'You',
  'groupInvitation.wechatDescription':
    'You are invited to join this group. Sign in or register to accept.',
  'groupInvitation.wechatReady':
    'Your invitation card is ready. Tap WeChat’s top-right menu, then Send to friends.',
  'groupInvitation.wechatLoading': 'Preparing your WeChat invitation card…',
  'groupInvitation.wechatFailed':
    'WeChat sharing is currently unavailable. Copy the invitation link or save the QR code to share.',
};
