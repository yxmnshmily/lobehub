export default {
  ...
  'connector.permission.approval': 'Needs approval',
  'connector.permission.approvalAll': 'Needs approval all',
  'connector.permission.auto': 'Auto — AI calls directly',
  'connector.permission.autoAll': 'Auto all',
  'connector.permission.custom': 'Custom',
  'connector.permission.disableAll': 'Disable all',
  'connector.permission.disabled': 'Disabled — hidden from AI',
  'connector.permission.statusApproval': 'Needs approval',
  'connector.permission.statusAuto': 'Auto',
  'connector.permission.statusDisabled': 'Disabled',
